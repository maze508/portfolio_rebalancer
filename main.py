...
def main():
    if not check_input(total_cash, cash_currency, target_asset_alloc):
    ...
    indiv_share_price, current_asset_values, old_allocation, new_assets_values, assets_to_buy, units_to_buy, price_of_units_to_buy, final_quantity, current_portfolio_worth, current_portfolio_values, new_allocation, largest_discrepancy, cash_spent, cash_remaining, target_alloc = port_rebalance(cash_currency, sum_total_cash_in_usd, target_asset_alloc, current_port)
